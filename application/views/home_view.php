   	...
   	<div class="row masonry">
         ...
         <div class="bricks-wrapper">
			   			...
			   			<ul class="slides">
				   			...
				   			<li>
				   				<div class="featured-post-slide">
						   			...
						   			<div class="post-background" style="background-image:url('<?php echo base_url() ?>assets/images/thumbs/featured/featured-1.jpg');"></div>
				   			...
				   			<li>
				   				<div class="featured-post-slide">
						   			...
						   			<div class="post-background" style="background-image:url('<?php echo base_url() ?>assets/images/thumbs/featured/featured-2.jpg');"></div>
				   			...
				   			<li>
				   				<div class="featured-post-slide">
						   			...
						   			<div class="post-background" style="background-image:url('<?php echo base_url() ?>assets/images/thumbs/featured/featured-3.jpg');;"></div>
         	...
         	<article class="brick entry format-standard animate-this">
               ...
               <div class="entry-thumb">
                  <a href="single-standard.html" class="thumb-link">
	                  <img src="<?php echo base_url() ?>assets/images/thumbs/diagonal-building.jpg" alt="building">             
                  </a>
               </div>
            ...
            <article class="brick entry format-standard animate-this">
               ...
               <div class="entry-thumb">
                  <a href="single-standard.html" class="thumb-link">
	                  <img src="<?php echo base_url() ?>assets/images/thumbs/ferris-wheel.jpg" alt="ferris wheel">                   
                  </a>
               </div>
            ...
            <article class="brick entry format-audio animate-this">
               ...
               <div class="entry-thumb">
                  <a href="single-audio.html" class="thumb-link">
	                  <img src="<?php echo base_url() ?>assets/images/thumbs/concert.jpg" alt="concert">                      
                  </a>
         	...
         	<article class="brick entry animate-this">
               ...
               <div class="entry-thumb">
                  <a href="single-standard.html" class="thumb-link">
	                  <img src="<?php echo base_url() ?>assets/images/thumbs/shutterbug.jpg" alt="Shutterbug">                      
                  </a>
               </div>
            ...
            <article class="brick entry animate-this" >
               ...
               <div class="entry-thumb">
                  <a href="single-standard.html" class="thumb-link">
	                  <img src="<?php echo base_url() ?>assets/images/thumbs/usaf-rocket.jpg" alt="USAF rocket">                      
                  </a>
               </div>
               ...
               <div class="entry-thumb">
                  ...
                  <div class="post-slider flexslider">
							<ul class="slides">
								<li>
									<img src="<?php echo base_url() ?>assets/images/thumbs/gallery/work1.jpg"> 
								</li>
								<li>
									<img src="<?php echo base_url() ?>assets/images/thumbs/gallery/work2.jpg"> 
								</li>
								<li>
									<img src="<?php echo base_url() ?>assets/images/thumbs/gallery/work3.jpg"> 
								</li>
							</ul>							
						</div> 
         	...
         	<article class="brick entry animate-this">
               ...
               <div class="entry-thumb">
                  <a href="single-standard.html" class="thumb-link">
	                  <img src="<?php echo base_url() ?>assets/images/thumbs/diagonal-pattern.jpg" alt="Pattern">              
                  </a>
               </div>
               ...
               <div class="entry-thumb video-image">
                  <a href="http://player.vimeo.com/video/14592941?title=0&amp;byline=0&amp;portrait=0&amp;color=F64B39" data-lity>
	                  <img src="<?php echo base_url() ?>assets/images/thumbs/ottawa-bokeh.jpg" alt="bokeh">                   
                  </a>
               </div>
               ...
               <div class="entry-thumb">
                  <a href="single-standard.html" class="thumb-link">
	                  <img src="<?php echo base_url() ?>assets/images/thumbs/lighthouse.jpg" alt="Lighthouse">                      
                  </a>
               </div>
               ...
               <div class="entry-thumb">
                  <a href="single-standard.html" class="thumb-link">
	                  <img src="<?php echo base_url() ?>assets/images/thumbs/liberty.jpg" alt="Liberty">                      
                  </a>
               </div>
